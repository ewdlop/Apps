...
- Name: Profile Page >> should display and manage skill chips
- Location: C:\Games\AngularApp\angular-material-app\e2e\app.spec.ts:298:7
...
Call log:
  - waiting for locator('mat-tab:has-text("Preferences")')
    ...
    at C:\Games\AngularApp\angular-material-app\e2e\app.spec.ts:299:16
```
