...
- Name: Profile Page >> should handle security tab
- Location: C:\Games\AngularApp\angular-material-app\e2e\app.spec.ts:273:7
...
Call log:
  - waiting for locator('mat-tab:has-text("Security")')
    ...
    at C:\Games\AngularApp\angular-material-app\e2e\app.spec.ts:274:16
```
