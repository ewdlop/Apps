...
- Name: Dashboard Page >> should display recent activities
- Location: C:\Games\AngularApp\angular-material-app\e2e\app.spec.ts:140:7
...
Locator: locator('mat-list-item')
Expected: 5
Received: 4
Call log:
  - expect.toHaveCount with timeout 5000ms
  - waiting for locator('mat-list-item')
    9 × locator resolved to 4 elements
      - unexpected value "4"

    at C:\Games\AngularApp\angular-material-app\e2e\app.spec.ts:145:30
```
...
- text: +5.2% 12,345 Total Users +12.1% $98,765 Revenue -2.4% 2,847 Orders +0.8% 3.45% Conversion Project Progress Current project status and deadlines
- heading "Angular Material App" [level=4]
- text: "In Progress Due: Dec 15, 2024"
- progressbar
- text: 85%
- heading "E-commerce Platform" [level=4]
- text: "Near Completion Due: Dec 8, 2024"
- progressbar
- text: 92%
- heading "Mobile App Development" [level=4]
- text: "In Progress Due: Jan 20, 2025"
- progressbar
- text: 45%
- heading "API Integration" [level=4]
- text: "Completed Due: Nov 30, 2024"
- progressbar
- text: 100%
- button "View All Projects"
- button "Create New"
- text: Recent Activities Latest updates and notifications New user registered John Doe • 2 minutes ago
- separator
- text: Order completed Jane Smith • 15 minutes ago
- separator
- text: Payment received Mike Johnson • 1 hour ago
- separator
- text: New review posted Sarah Wilson • 2 hours ago
- button "View All Activities"
- text: Quick Actions Frequently used actions and shortcuts
